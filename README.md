  ...
  （2）若（1）方法失效，可使用本方法：
    ...
    通过命令行切换到RNHybrid目录：
      ...
      若为新版（即RNHybrid目录中存在index.js），则执行以下命令：
        react-native bundle --platform android --dev false --entry-file index.js --bundle-output Android项目            名/app/src/main/assets/index.android.bundle --assets-dest Android项目名/app/src/main/res
----------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------
